...
export default function Sidebar() {
  ...
  return (
    <aside
      ...
      style={{ background: '#ffffff', borderRight: '1px solid var(--color-border)', fontFamily: 'var(--font-main)' }}
    >
      {/* Logo */}
      ...
      <div className="px-2 pb-4">
        <button onClick={handleLogout}
          ...
          onMouseEnter={e => { (e.currentTarget as HTMLElement).style.background = '#fff1f0'; (e.currentTarget as HTMLElement).style.color = 'var(--color-danger)' }}
